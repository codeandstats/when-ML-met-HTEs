...
cols <- c(
  ...
  "doubleml" = "#009E73" #, "doubleml-honest" = "#006644"  # <--- added
)
...
refactor <- function(df, method.nams) {
  ...
  # TODO: split factor into respective columns p, m, t, nsim
...
if (HONESTY) colsub <- cols[c("mob",  "mob-honest", "hybrid",  "hybrid-honest",
  "equalized", "equalized-honest", "mobcf", "mobcf-honest", "cf",  "cf-honest", "doubleml")]
